...
---
I chose this project becasue I wanted to build something that connects to what I've already learned in my capstone course at UCSC (*CSE 143: Introduction to Natural Language Processing*) while pushing me further to explore AI and NLP. I have some experience with NLP and wanted to pick a project that would challenge me beyond than simply completing an assignment. 
I wanted to further dissect and explore how NLP models work, how to approach it in multiple ways, and evaluate efficiency of the models. I have chosen misinformation classification to apply my traditional NLP skills and master the use of newer transformer based models.
